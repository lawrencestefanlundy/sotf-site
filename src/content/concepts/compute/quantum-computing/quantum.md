...
- slug: photonic-quantum-computing
  ...
  macro: compute
---
**Quantum technologies use controllable quantum states as computational, communication and sensing resources; the sources show sensing and memory hardware already delivering measurable results while the computing leg remains at 6-to-10-qubit demonstrations plus simulator-stage error-correction theory.**
