...
related_concepts: []
companies_using:
- ampere-computing-cryo-research-group
- bluefors
- cea-leti
- delft-circuits
- diraq
...
- qblox
- quanten-technologies-formerly-hrl-laboratories-spin-out
- quantum-machines
- quantum-motion
- rigetti-computing
- scalinq
- semiqon
- siquance-grenoble-quantum-silicon
- tower-semiconductor
- tsmc
ideas_referencing: []
sources: []
...
Cloudberry's GlobalFoundries-LP fund has direct strategic relevance: GF's 22FDX is an active cryo CMOS development platform, creating deal-flow around IP, EDA tools, and characterization services that enable cryo-qualified design kits. Investable angles include cryo PDK startups, cryogenic test and characterization IP, and fabless teams building qubit control ASICs. Lunar Ventures' early-stage remit catches university spinouts (Delft, ETH, Oxford lineage) commercialising cryo mixed-signal IP before they need Series A semi-specialist capital.
