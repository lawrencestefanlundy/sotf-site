...
- apadding-apad-technologies
- asetek
- auras-technology
- calyos
- chilldyne
- coolit-systems
- dcx-data-center-cooling-exchange
...
- nventive-nvent-electric
- phononic
- schneider-electric
- submer
- supercritical-formerly-exodraft
- vertiv
- zutacore
ideas_referencing: []
sources:
...
Thermal management is a critical constraint in GF's advanced node packaging, photonic integrated circuits (where laser junction temperatures directly degrade coherence and lifetime), and power semiconductors. Deal-flow angles: novel TIM materials, embedded cooling in interposers, and thermally conductive dielectrics for photonic platforms. Diamond-on-silicon and AlN substrates are investable material plays. As AI accelerator power budgets exceed 1 kW per package, thermal IP becomes a structural bottleneck—fundable as enabler infrastructure rather than niche materials play.
