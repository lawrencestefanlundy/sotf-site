...
- slug: photonic-quantum-computing
  ...
  macro: compute
---
Broad **context tag**, not a differentiated concept. Created 8 Jul 2026 (connectivity redesign Phase 3) to terminate the second-largest dangling classifier tag (~1,280 occurrences in a 30-day window) — the pre-validation classifier's catch-all for anything quantum.

The real substrate is the children: [Quantum Computing](/compute/quantum-computing/quantum-computing/) (and its subtree under `concepts/compute/quantum-computing/`), [Quantum Sensing](/sensing/quantum-sensing/quantum-sensing/), QKD/post-quantum security concepts. A source tagged only `quantum` carries field-level context, not a claim about any particular modality — retrieval treats it as weak context, and the founder radar excludes it (`CONTEXT_CONCEPTS` denylist).

Do not attach theses here; attach them to the specific modality or layer.
