...
neighbors: []
---
> **Auto-stub** created 2026-07-27 to resolve 6 inbound reference(s) (e.g. `concepts/energy-power/carbon-capture/ocean-alkalinity.md`). Type inferred from field. Needs enrichment (replace this banner with real content, then drop the `auto-stub` tag).
