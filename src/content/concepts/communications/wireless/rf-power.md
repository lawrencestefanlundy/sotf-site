...
neighbors: []
---
> **Auto-stub** created 2026-07-08 to resolve 3 inbound reference(s) (e.g. `companies/thermaflux.md`). Type inferred from field. Needs enrichment (replace this banner with real content, then drop the `auto-stub` tag).
