...
- the devices are **non-volatile** and **stack vertically** via [3D Monolithic Integration](/compute/compute-architecture/3d-monolithic-integration/), so compute density scales by adding layers rather than by buying leading-edge lithography.
