...
sources: []
frontier:
- Does quantum-dot ZnSe (Cd-free) achieve sufficient colour purity and lifetime to displace CdSe in commercial display backlights at volume pricing — what is the Cd-free QD roadmap timeline?
- 'ZnSe as a mid-IR window: does the cost premium over ZnS or Ge remain justified for high-performance thermal-imaging applications, or does CVD diamond start to crowd it out?'
- Is there a manufacturable route to ZnSe waveguides for broadly tunable mid-IR laser sources (OPO pump windows 0.45–21.5 µm), and who is the nearest-to-production supplier?
