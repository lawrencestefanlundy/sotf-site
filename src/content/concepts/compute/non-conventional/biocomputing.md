...
- A killer app — any task where wetware beats silicon on a metric a customer pays for (not Pong/DOOM)
- Does the value sit in the wetware, or in the picks-and-shovels (HD-MEA hardware, organoid supply)?
- Is there a Cloudberry-shaped (semiconductor/photonics-adjacent) wedge, or is the only investable layer drug-discovery tooling (off-mandate)?
