...
- hedvig-wireless-airhop-communications
- infineon-technologies
- kognia-formerly-wiquest-cohere-technologies
- metawave
- movella-mcube
- nokia
...
*Kind: technology · Attio deal count: 44*
...
GlobalFoundries maintains a dedicated RF-SOI and SiGe BiCMOS platform (GF 22FDX, 8HP) directly serving 5G front-end and Wi-Fi chipmakers—core to Cloudberry's LP relationship. Deal-flow angles: RF filter startups (BAW/FBAR alternatives, novel piezoelectrics), mmWave beamforming ICs, GaN-on-Si power amplifiers, and photonic-RF integration (RFoF, LiDAR/radar fusion). Compound semiconductor fabs seeking GF process partnerships are a natural pipeline. Lunar Ventures' software-adjacent portfolio may surface fabless RF design teams needing foundry access.
