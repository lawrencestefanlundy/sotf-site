...
frontier:
- 'Which physical layer wins inside the rack at the next accelerator generation: passive copper, active electrical cable, pluggable optics, or co-packaged optics, and at what bandwidth density does each stop scaling?'
- What is the measured energy per bit and bit error rate of shipping rack-scale optical links, and how do they compare with the electrical incumbents they replace?
- How much of the Q2 2026 datacentre-infrastructure funding flagged as "interconnect" went to optical rack-scale links specifically, versus switch silicon, retimers or protocol IP?
- Do rack-scale interconnect startups reach volume qualification with hyperscalers, or does the segment consolidate into the existing switch and optics vendors?
sources_7d: 0
sources_30d: 0
recent_mentions:
