...
- teledyne-e2v
- tercica-formerly-heptagon-now-part-of-ams
- texas-instruments
- xenomatix
ideas_referencing: []
sources: []
...
| Modality | Range | Cost | Outdoor robustness |
|---|---|---|---|
| iToF | <5 m | Low | Poor |
| dToF / SPAD | 0.1–200 m | Mid | Good |
| FMCW LiDAR | 10–300 m | High | Excellent |


SPAD arrays and TDC ASICs are fab-intensive; GlobalFoundries' 22FDX and 45CLO nodes are relevant process candidates for integrated dToF receiver ICs. Deal-flow angles: SPAD foundry IP, readout ASIC startups, photonics-integrated dToF for automotive or industrial robotics, and software-defined multipath correction. Lunar Ventures' sensor/perception portfolio overlaps here. The commodity iToF market is crowded; differentiated opportunities sit in SPAD process IP, monolithic VCSEL+detector integration, and FMCW transition plays.
