...
canonical_name: Gallium Antimonide
aliases:
- GaSb
- gallium antimonide
parent_concepts:
...
**Brolis Semiconductors** produces GaSb-based mid-IR laser diode bars and modules. The **Mid Ir Photonic Sensing** thesis tracks the commercial opportunity in molecular spectroscopy enabled by antimonide emitters. [Indium Antimonide](/materials/substrates/indium-antimonide/) and [Indium Arsenide](/materials/substrates/indium-arsenide/) are close lattice-matched siblings used in longer-wavelength detector applications.
