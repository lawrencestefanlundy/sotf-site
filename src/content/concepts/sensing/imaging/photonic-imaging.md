...
- **3D / ranging:** LiDAR (direct ToF and FMCW), structured-light, and passive stereo — all relying on [Time-of-Flight (iToF, dToF)](/sensing/ranging-detection/time-of-flight/) measurement or geometric triangulation. [SPAD arrays](/photonic-systems/modulators-detectors/avalanche-photodiode/) are the detector of choice for single-photon 3D sensing.
- **Hyperspectral and multispectral:** snapshot or scanning imagers that resolve a spectral dimension (near-IR through LWIR) across each pixel, enabling material identification and gas-column imaging. [Mercury Cadmium Telluride](/photonic-systems/modulators-detectors/hgcdte/) FPAs dominate the thermal infrared bands; filter-wheel and Fabry–Pérot approaches serve near-IR.
...
The deep-tech investment angle is the **integration wedge**: moving from discrete optics + large focal-plane arrays to chip-scale photonic ICs with on-chip spectral filtering and pixel-level processing. [Mid-Infrared Photonics](/photonic-systems/light-sources/mid-ir-photonics/) integration drives cost reduction in spectroscopic imaging; [Silicon Photonics](/photonic-systems/pic-platforms/silicon-photonics/) underpins near-IR FMCW LiDAR.
