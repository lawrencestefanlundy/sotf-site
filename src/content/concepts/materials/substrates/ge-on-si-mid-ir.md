...
*Kind: technology · CMOS-fab-compatible mid-IR waveguide platform for gas / breath / hyperspectral sensing*
...
Research mature, production emerging. Active work: CEA-LETI (France), IMEC (Belgium), University of Southampton (UK), MIT (Kimerling group), Caltech. Commercial: Aurelia Optics (you have this in pipeline), several MIR-focused startups. Foundry support: GF Fotonix has a Ge module; Smart Photonics path less clear.

## Cloudberry relevance

Direct via **Mid Ir Photonic Sensing** — Ge-on-Si is one of two main waveguide-platform candidates (other being [[chalcogenide-glass]]). Adjacent via [[quantum-cascade-lasers]] which provides the source side. Aylight, Aurelia, Olfactomics, Prospectral all sit in this segment.
