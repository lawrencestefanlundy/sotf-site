...
In electrochemical carbon capture using molten carbonates, a molten salt such as lithium carbonate (Li2CO3) acts as both electrolyte and CO2 carrier: CO2 is absorbed into the carbonate melt and released or reduced under an applied potential at high temperature. Li2CO3 is described as a cornerstone material for clean energy technologies spanning high-temperature molten carbonate fuel cells, electrochemical carbon capture and lithium-based batteries probing structure and ionic transport in molten lithium carb. The governing performance parameters are therefore the structure and ionic transport of the melt (ion diffusivity, conductivity, local coordination), which set the achievable current density and the energy penalty per tonne of CO2.

Modelling those melts is the bottleneck addressed in the source. Ab initio molecular dynamics captures the many-body interactions in molten Li2CO3 but is computationally expensive, while classical force fields are cheaper but less accurate probing structure and ionic transport in molten lithium carb. Equivariant graph-based machine-learned interatomic potentials, specifically the multi atomic cluster expansion (MACE) and neural equivariant interatomic potential (NequIP) architectures, were trained on melt-quench ab initio molecular dynamics data, with MACE reported to give superior transferability and precision probing structure and ionic transport in molten lithium carb. This positions machine-learned potentials as a screening tool for carbonate melt compositions before experimental work.

## Competitive landscape

The sources do not support a quantitative comparison between capture approaches. They do indicate two distinct demand pulls: government-funded exploration of novel capture concepts, with ASU, NAU and UT Austin awarded $1.5M from the US Department of Energy for a new carbon capture concept intended to transform energy technology asu nau and ut austin awarded 15m from doe to transform ener, and capture as a route to firm, lower-emissions generation for data centre load serving data center load with carbon capture   latitude medi. The latter places carbon capture in implicit competition with other firm clean-power options for compute, a category in which fusion and small modular reactors are also discussed, though on timelines that lag commercial electricity supply by years after technical milestones nuclear fusion the state of play.

## Evidence base

- Li2CO3 is identified as a cornerstone material for molten carbonate fuel cells, electrochemical carbon capture and lithium batteries, with molten-state structure and transport still poorly captured by existing methods (15 June 2026) probing structure and ionic transport in molten lithium carb.
- MACE and NequIP potentials trained on melt-quench ab initio molecular dynamics data reproduce molten Li2CO3 behaviour, with MACE showing superior transferability and precision (15 June 2026) probing structure and ionic transport in molten lithium carb.
- ASU, NAU and UT Austin received $1.5M from the DOE for a new carbon capture concept (21 February 2019) asu nau and ut austin awarded 15m from doe to transform ener.
- Carbon capture is being discussed as a means of serving data centre load (17 April 2025) serving data center load with carbon capture   latitude medi.
