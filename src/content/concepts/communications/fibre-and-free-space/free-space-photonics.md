...
Commercial relevance concentrates in: (1) **inter-satellite optical links** (SpaceX Starlink, Mynaric, Tesat), where FSO offers 10–100× higher throughput than RF at competitive SWaP; (2) **terrestrial last-mile** in urban dense deployments; (3) **LiDAR** as a ranging modality (see [LiDAR](/sensing/ranging-detection/lidar/)). **Zigzag Networks** applies free-space optical beam-forming in its network architecture. **Diffractive Deep Neural Network** descends from this space as a compute modality.
