...
- sk-telecom-quantum
- speqtral
- tenet-communications-formerly-qkd-as-a-service
- thinkquantum
- toshiba-corporation-quantum-japan
...
Photonics is the core enabling layer—integrated QKD transceivers, SNSPDs, and entanglement sources are chip-scale opportunities directly in Cloudberry's semiconductor/photonics thesis. GF's silicon photonics platform (GF Fotonix, 300mm) is a credible substrate for integrated QKD PICs. Deal-flow angles: fabless QKD chip startups, SNSPD detector companies, quantum memory material plays (rare-earth-doped crystals, colour centres). UK/EU sovereign communications mandates are pulling institutional procurement, creating defensible first-mover positions for early-stage hardware bets.
