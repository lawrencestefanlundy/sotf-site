...
companies_using:
- adiabatic-labs
- bitlogic-formerly-logiq
- d-wave-systems
- horizon-quantum-computing
- ibm-quantum
- imec
- iqm-quantum-computers
- landauer-inc-acquired-by-agiliti
- menten-ai-spun-out-parent-peptone
- micro-magic
...
Energy efficiency is the primary constraint in AI inference silicon, edge compute, and datacentre scaling—all sectors Cloudberry tracks through GlobalFoundries-LP context. A portfolio angle exists wherever a fabless startup is differentiating on power envelope at sub-28 nm nodes or designing custom adiabatic controllers. Lunar Ventures' software-heavy deals are less relevant, but any deep-tech bet on novel compute architecture (neuromorphic, analog AI, photonic compute) should be pressure-tested against reversible logic as an alternative route to the same energy-per-operation target.
