...
neighbors: []
---
> **Auto-stub** created 2026-07-27 to resolve 1 inbound reference(s) (e.g. `concepts/manufacturing/equipment-processes/ion-implantation.md`). Type inferred from field. Needs enrichment (replace this banner with real content, then drop the `auto-stub` tag).
