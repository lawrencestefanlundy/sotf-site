...
neighbors: []
---
> **Auto-stub** created 2026-07-22 to resolve 5 inbound reference(s) (e.g. `ideas/chip-scale-bio-instrumentation.md`). Type inferred from field. Needs enrichment (replace this banner with real content, then drop the `auto-stub` tag).
