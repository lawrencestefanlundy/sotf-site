...
- slug: optical-interconnect
  ...
  macro: communications
---
*The frontier sibling of [Optical Circuit Switching (OCS)](/communications/optical-interconnect/optical-circuit-switching/) — switching at packet granularity rather than dedicated lightpaths.*
...
- Tech: [Lithium Niobate (TFLN)](/materials/functional-layers/lithium-niobate-tfln/) used for **frequency mixing** (the non-linearity), not modulation; poling is the hard step. First patent is an all-optical passive ALU (**Non Linear Photonic Logic**).
