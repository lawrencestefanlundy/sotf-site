...
5. TechInvestments.io, "A Primer on the Deposition Market" (AMAT ~21%, Lam ~18%, TEL ~16% of deposition; PVD an AMAT near-monopoly; ALD led by TEL/ASM). https://www.techinvestments.io/p/a-primer-on-the-deposition-market [Correction 3 Sep 2026: the AMAT ~21% / Lam ~18% / TEL ~16% deposition split came from a non-semi $63B base and is retired; reconciled to AMAT #1 at c.30% of the c.$23B WFE-defined semi deposition segment, Lam/TEL mid-teens to ~20%. See **Deposition Materials Process Market** belief_changes 2026-09-03.]
