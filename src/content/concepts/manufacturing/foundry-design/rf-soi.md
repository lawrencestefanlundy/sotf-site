...
What the sources do establish is the platform context. GlobalFoundries frames its 2026 strategy around "Physical AI" organised into sense / think / act / communicate, and positions itself as a "feature-rich, not node-leading" specialty foundry rather than a leading-edge logic competitor gf investor day 2026. RF connectivity sits inside the "communicate" pillar of that framing, alongside the compute and embedded-memory pillars that the deck documents in more detail.

The same deck names a specialty process portfolio spanning FDX, FinFET and BCD platforms, with an embedded non-volatile memory offering (eMRAM, ReRAM, FLASH) layered across them gf investor day 2026. RF SOI is not enumerated in the excerpt available here, so its relationship to those platforms, and any co-integration of RF front-end and embedded memory on a single die, is undocumented in these sources.

## Competitive landscape

No comparison is supportable from the supplied sources. The only positioning claim available is company-level: GlobalFoundries describes itself as a specialty foundry competing on feature richness rather than transistor density, with FY2025 financials and 2028 targets organised around Physical AI end markets gf investor day 2026. Competing RF SOI suppliers, wafer vendors, substrate types (trap-rich vs high-resistivity) and alternative front-end technologies (GaAs, SOI CMOS vs bulk CMOS switches) are not covered by anything cited here.

## Evidence base

- GlobalFoundries published a 101-slide Investor Day 2026 deck on investors.gf.com covering whole-company strategy, FY2025 financials and 2028/long-term targets gf investor day 2026.
- The deck organises GF's strategy around "Physical AI" split into sense / think / act / communicate, the pillar structure into which RF connectivity products fall gf investor day 2026.
- GF publicly positions itself as a "feature-rich, not node-leading" specialty foundry gf investor day 2026.
- The deck names a specialty platform set of FDX, FinFET and BCD, with a broad eNVM portfolio (eMRAM, ReRAM, FLASH) across them gf investor day 2026.
- The excerpt reviewed for this page contains no RF SOI process, performance or capacity data gf investor day 2026.
