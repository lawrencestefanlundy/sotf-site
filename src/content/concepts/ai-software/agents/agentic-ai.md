...
neighbors: []
---
> **Auto-stub** created 2026-08-04 to resolve 3 inbound reference(s) (e.g. `companies/chipagents.md`). Type inferred from field. Needs enrichment (replace this banner with real content, then drop the `auto-stub` tag).
