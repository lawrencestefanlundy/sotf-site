...
canonical_name: Indium Gallium Nitride
aliases:
- InGaN
...
sources: []
frontier:
- Can micro-LED displays using InGaN reach the luminous efficiency and pixel-level uniformity needed for mass-market AR glasses before oxide-TFT backplane costs make them viable?
- Does InGaN's anomalously high efficiency at low carrier density ('the InGaN efficiency mystery') fully yield to V-pit and strain engineering, or does indium segregation remain a fundamental ceiling?
- Will InGaN-based tandem solar cells (stacked with Si) break the single-junction Shockley–Queisser limit in production, making them competitive with III-V multi-junction cells at a fraction of the cost?
...
- Can micro-LED displays using InGaN reach the luminous efficiency and pixel-level uniformity needed for mass-market AR glasses before oxide-TFT backplane costs make them viable?
- Does InGaN's anomalously high efficiency at low carrier density fully yield to V-pit and strain engineering, or does indium segregation remain a fundamental ceiling?
- Will InGaN-based tandem solar cells (stacked with Si) break the single-junction Shockley–Queisser limit in production, making them competitive with III-V multi-junction cells at a fraction of the cost?
