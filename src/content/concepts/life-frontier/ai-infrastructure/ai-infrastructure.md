...
neighbors: []
---
> **Auto-stub** created 2026-07-08 to resolve 9 inbound reference(s) (e.g. `ideas/risc-v-open-silicon-share.md`). Type inferred from field. Needs enrichment (replace this banner with real content, then drop the `auto-stub` tag).
