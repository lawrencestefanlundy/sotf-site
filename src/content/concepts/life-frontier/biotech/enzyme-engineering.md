...
- NSF award 2548668, dated 06/02/2026, funds development of improved aromatic-metabolizing enzymes through generalizable enzyme engineering strategies.
- The award totals $392,649 under the Cellular & Biochemical Engineering programme, with PI Jordan Froese at Ball State University, Muncie, IN.
- The stated motivation is that aromatic-containing chemicals, fragrances and drugs require complicated multi-step synthesis that often gives low yields.
- Each protect/react/deprotect repetition is described as reducing overall process efficiency while adding energy requirements and solvent waste.
- The project is a Research in Undergraduate Institutions (RUI) award, with experiments performed by undergraduate research teams.
